<?php namespace CSI\BbCodeSteamCard\BbCode\Formatter;

/**
 * Class Base
 * @package CSI\BbCodeSteamCard\BbCode\Formatter
 */
class Base
{
  /**
   ...
   * @return mixed
   */
  public static function getBbCodeSteamCard(array $tag, array $rendererStates, \XenForo_BbCode_Formatter_Base $formatter)
  {
    ...
    if ($view) {
      $template = $view->createTemplateObject('csiXF_bbCode_E13C63A6_tag_steam_card',
        array(
          'content' => $tagContent,
          'query' => $tagQuery,
        ));
